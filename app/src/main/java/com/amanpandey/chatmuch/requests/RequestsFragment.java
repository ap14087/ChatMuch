...
public class RequestsFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        tvEmptyRequestsList = view.findViewById(R.id.tvEmptyRequestList);
                        ...
                        if(requestType.equals(Constants.REQUEST_STATUS_RECEIVED))
                        {
                            ...
                            databaseReferenceUsers.child(userId).addListenerForSingleValueEvent(new ValueEventListener() {
                                ...
                                public void onCancelled(@NonNull DatabaseError error) {
                                    Toast.makeText(getActivity(), "Failed to fetch friend request : " + error.getMessage(), Toast.LENGTH_SHORT).show();
                                    progressBar.setVisibility(View.GONE);
                                }
                            });
                        }
