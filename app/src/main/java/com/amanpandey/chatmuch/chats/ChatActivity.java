...
public class ChatActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void sendMessage(String msg, String msgType, String pushId) {
        ...
        try {
            ...
            Toast.makeText(ChatActivity.this, "Failed to send message : " + ex.getMessage(), Toast.LENGTH_SHORT).show();
        }
    }
        ...
        switch (view.getId()) {
            case R.id.ivSend:
                if (Util.connectionAvailable(this)) {
                    DatabaseReference userMesssagePush = mRootRef.child(NodeNames.MESSAGES).child(currentUserId).child(chatUserId).push();
                    String pushId = userMesssagePush.getKey();
                    ...
                    databaseReferenceChatUser.removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            ...
                            if (task.isSuccessful()) {
                                ...
                                Toast.makeText(ChatActivity.this,"Failed to delete message" + task.getException(),
